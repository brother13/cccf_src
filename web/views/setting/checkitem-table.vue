<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="项目编码" prop="itemcode" align="left" width="180" />
      <el-table-column label="项目名称" prop="itemname" align="center" width="180" />
      <el-table-column label="项目层级" prop="itemlevel" align="center" width="120" />
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        <el-form-item label="项目编码" prop="itemcode">
          <el-input v-model="temp.itemcode" />
        </el-form-item>
        ...
        <el-form-item label="项目级别" prop="itemlevel">
          <el-input v-model="temp.itemlevel" type="number" />
        </el-form-item>
