...
function dataURLtoFile(dataurl, filename) {
  ...
  if (suffix == 'jpg' || suffix == 'JPG') { return new File([u8arr], filename, { type: 'image/jpg' }) }
  if (suffix == 'png' || suffix == 'PNG') { return new File([u8arr], filename, { type: 'image/png' }) }
  if (suffix == 'tif' || suffix == 'TIF') { return new File([u8arr], filename, { type: 'image/tiff' }) }
  if (suffix == 'pdf' || suffix == 'PDF') { new File([u8arr], filename, { type: 'application/pdf' }) }
