...
-1 ? this.slice(j) : this.slice(j, +j + 1)
    }, first: function() { return this.eq(0) }, last: function() { return this.eq(-1) }, slice: function() { return this.pushStack(N.apply(this, arguments), 'slice', N.call(arguments).join(',')) }, map: function(j) { return this.pushStack(b.map(this, function(s, v) { return j.call(s, v, s) })) }, end: function() { return this.prevObject || b(null) }, push: M, sort: [].sort, splice: [].splice }; b.fn.init.prototype = b.fn; b.extend = b.fn.extend = function() {
...
l.test(j)) { var s = t.getElementsByTagName('head')[0] || t.documentElement; var v = t.createElement('script'); v.type = 'text/javascript'; if (b.support.scriptEval)v.appendChild(t.createTextNode(j)); else v.text = j; s.insertBefore(v, s.firstChild); s.removeChild(v) }
      ...
      s) { var v = j.length; var z = 0; if (typeof s.length === 'number') for (var H = s.length; z < H; z++)j[v++] = s[z]; else for (;s[z] !== B;)j[v++] = s[z++]; j.length = v; return j }, grep: function(j, s, v) { var z = []; var H; v = !!v; for (var G = 0, K = j.length; G < K; G++) { H = !!s(j[G], G); v !== H && z.push(j[G]) } return z }, map: function(j, s, v) { for (var z = [], H, G = 0, K = j.length; G < K; G++) { H = s(j[G], G, v); if (H != null)z[z.length] = H } return z.concat.apply([], z) }, guid: 1, proxy: function(j, s, v) {
...
'none'
  ...
  })(); var ra = {}; var Ja = /^(?:\{.*\}|\[.*\])$/; c.extend({ cache: {}, uuid: 0, expando: 'jQuery' + c.now(), noData: { embed: true, object: 'clsid:D27CDB6E-AE6D-11cf-96B8-444553540000', applet: true }, data: function(a, b, d) {
    if (c.acceptData(a)) {
...
c.data(a, b); if (!d) return e || []; if (!e || c.isArray(d))e = c.data(a, b, c.makeArray(d)); else e.push(d); return e
  ...
  }, dequeue: function(a, b) { b = b || 'fx'; var d = c.queue(a, b); var e = d.shift(); if (e === 'inprogress')e = d.shift(); if (e) { b === 'fx' && d.unshift('inprogress'); e.call(a, function() { c.dequeue(a, b) }) } } }); c.fn.extend({ queue: function(a, b) { if (typeof a !== 'string') { b = a; a = 'fx' } if (b === B) return c.queue(this[0], a); return this.each(function() { var d = c.queue(this, a, b); a === 'fx' && d[0] !== 'inprogress' && c.dequeue(this, a) }) }, dequeue: function(a) {
    return this.each(function() {
      c.dequeue(this,
        a)
    })
  }, delay: function(a, b) { a = c.fx ? c.fx.speeds[a] || a : a; b = b || 'fx'; return this.queue(b, function() { var d = this; setTimeout(function() { c.dequeue(d, b) }, a) }) }, clearQueue: function(a) { return this.queue(a || 'fx', []) } }); var sa = /[\n\t]/g; var ha = /\s+/; var Sa = /\r/g; var Ta = /^(?:href|src|style)$/; var Ua = /^(?:button|input)$/i; var Va = /^(?:button|input|object|select|textarea)$/i; var Wa = /^a(?:rea)?$/i; var ta = /^(?:radio|checkbox)$/i; c.props = { 'for': 'htmlFor', 'class': 'className', readonly: 'readOnly', maxlength: 'maxLength', cellspacing: 'cellSpacing', rowspan: 'rowSpan',
    colspan: 'colSpan', tabindex: 'tabIndex', usemap: 'useMap', frameborder: 'frameBorder' }; c.fn.extend({ attr: function(a, b) { return c.access(this, a, b, true, c.attr) }, removeAttr: function(a) { return this.each(function() { c.attr(this, a, ''); this.nodeType === 1 && this.removeAttribute(a) }) }, addClass: function(a) {
...
i ? q || false : q === i
    ...
    }, '>': function(g, i) { var n; var m = typeof i === 'string'; var p = 0; var q = g.length; if (m && !/\W/.test(i)) for (i = i.toLowerCase(); p < q; p++) { if (n = g[p]) { n = n.parentNode; g[p] = n.nodeName.toLowerCase() === i ? n : false } } else { for (;p < q; p++) if (n = g[p])g[p] = m ? n.parentNode : n.parentNode === i; m && k.filter(i, g, true) } }, '': function(g, i, n) { var m; var p = e++; var q = b; if (typeof i === 'string' && !/\W/.test(i)) { m = i = i.toLowerCase(); q = a }q('parentNode', i, p, g, m, n) }, '~': function(g, i, n) {
...
i = i.toLowerCase(); q = a
      ...
      m, p, q) { i = g[1].replace(/\\/g, ''); if (!q && o.attrMap[i])g[1] = o.attrMap[i]; if (g[2] === '~=')g[4] = ' ' + g[4] + ' '; return g }, PSEUDO: function(g, i, n, m, p) { if (g[1] === 'not') if ((d.exec(g[3]) || '').length > 1 || /^\w/.test(g[3]))g[3] = k(g[3], null, null, i); else { g = k.filter(g[3], i, n, true ^ p); n || m.push.apply(m, g); return false } else if (o.match.POS.test(g[0]) || o.match.CHILD.test(g[0])) return true; return g }, POS: function(g) { g.unshift(true); return g } }, filters: { enabled: function(g) { return g.disabled === false && g.type !== 'hidden' }, disabled: function(g) {
      return g.disabled ===
true
    }, checked: function(g) { return g.checked === true }, selected: function(g) { return g.selected === true }, parent: function(g) { return !!g.firstChild }, empty: function(g) { return !g.firstChild }, has: function(g, i, n) { return !!k(n[3], g).length }, header: function(g) { return /h\d/i.test(g.nodeName) }, text: function(g) { return g.type === 'text' }, radio: function(g) { return g.type === 'radio' }, checkbox: function(g) { return g.type === 'checkbox' }, file: function(g) { return g.type === 'file' }, password: function(g) { return g.type === 'password' }, submit: function(g) {
      return g.type ===
'submit'
...
i
    }, CLASS: function(g, i) { return (' ' + (g.className || g.getAttribute('class')) + ' ').indexOf(i) > -1 }, ATTR: function(g, i) { var n = i[1]; n = o.attrHandle[n] ? o.attrHandle[n](g) : g[n] != null ? g[n] : g.getAttribute(n); var m = n + ''; var p = i[2]; var q = i[4]; return n == null ? p === '!=' : p === '=' ? m === q : p === '*=' ? m.indexOf(q) >= 0 : p === '~=' ? (' ' + m + ' ').indexOf(q) >= 0 : !q ? m && n !== false : p === '!=' ? m !== q : p === '^=' ? m.indexOf(q) === 0 : p === '$=' ? m.substr(m.length - q.length) === q : p === '|=' ? m === q || m.substr(0, q.length + 1) === q + '-' : false }, POS: function(g, i, n, m) {
...
t.createElement('div'); g.innerHTML = "<div class='test e'></div><div class='test'></div>"; if (!(!g.getElementsByClassName || g.getElementsByClassName('e').length === 0)) { g.lastChild.className = 'e'; if (g.getElementsByClassName('e').length !== 1) { o.order.splice(1, 0, 'CLASS'); o.find.CLASS = function(i, n, m) { if (typeof n.getElementsByClassName !== 'undefined' && !m) return n.getElementsByClassName(i[1]) }; g = null } }
  ...
  })(); var Za = /Until$/; var $a = /^(?:parents|prevUntil|prevAll)/; var ab = /,/; var Na = /^.[^:#\[\.,]*$/; var bb = Array.prototype.slice; var cb = c.expr.match.POS; c.fn.extend({ find: function(a) { for (var b = this.pushStack('', 'find', a), d = 0, e = 0, f = this.length; e < f; e++) { d = b.length; c.find(a, this[e], b); if (e > 0) for (var h = d; h < b.length; h++) for (var l = 0; l < d; l++) if (b[l] === b[h]) { b.splice(h--, 1); break } } return b }, has: function(a) { var b = c(a); return this.filter(function() { for (var d = 0, e = b.length; d < e; d++) if (c.contains(this, b[d])) return true }) },
...
h.parentNode; o++
    ...
    }, andSelf: function() { return this.add(this.prevObject) } }); c.each({ parent: function(a) { return (a = a.parentNode) && a.nodeType !== 11 ? a : null }, parents: function(a) { return c.dir(a, 'parentNode') }, parentsUntil: function(a, b, d) { return c.dir(a, 'parentNode', d) }, next: function(a) { return c.nth(a, 2, 'nextSibling') }, prev: function(a) {
    return c.nth(a,
      2, 'previousSibling')
...
c(this); d.text(a.call(this, b, d.text()))
  ...
  wrapInner: function(a) { if (c.isFunction(a)) return this.each(function(b) { c(this).wrapInner(a.call(this, b)) }); return this.each(function() { var b = c(this); var d = b.contents(); d.length ? d.wrapAll(a) : b.append(a) }) }, wrap: function(a) { return this.each(function() { c(this).wrapAll(a) }) }, unwrap: function() { return this.parent().each(function() { c.nodeName(this, 'body') || c(this).replaceWith(this.childNodes) }).end() }, append: function() { return this.domManip(arguments, true, function(a) { this.nodeType === 1 && this.appendChild(a) }) },
  prepend: function() { return this.domManip(arguments, true, function(a) { this.nodeType === 1 && this.insertBefore(a, this.firstChild) }) }, before: function() { if (this[0] && this[0].parentNode) return this.domManip(arguments, false, function(b) { this.parentNode.insertBefore(b, this) }); else if (arguments.length) { var a = c(arguments[0]); a.push.apply(a, this.toArray()); return this.pushStack(a, 'before', arguments) } }, after: function() {
    ...
    return this
  }, clone: function(a) { var b = this.map(function() { if (!c.support.noCloneEvent && !c.isXMLDoc(this)) { var d = this.outerHTML; var e = this.ownerDocument; if (!d) { d = e.createElement('div'); d.appendChild(this.cloneNode(true)); d = d.innerHTML } return c.clean([d.replace(za, '').replace(fb, '="$1">').replace($, '')], e)[0] } else return this.cloneNode(true) }); if (a === true) { na(this, b); na(this.find('*'), b.find('*')) } return b }, html: function(a) {
...
1; o >= 0; --o)c.nodeName(k[o], 'tbody') && !k[o].childNodes.length && k[o].parentNode.removeChild(k[o])
  ...
  }, cleanData: function(a) { for (var b, d, e = c.cache, f = c.event.special, h = c.support.deleteExpando, l = 0, k; (k = a[l]) != null; l++) if (!(k.nodeName && c.noData[k.nodeName.toLowerCase()])) if (d = k[c.expando]) { if ((b = e[d]) && b.events) for (var o in b.events)f[o] ? c.event.remove(k, o) : c.removeEvent(k, o, b.handle); if (h) delete k[c.expando]; else k.removeAttribute && k.removeAttribute(c.expando); delete e[d] } } }); var Ea = /alpha\([^)]*\)/i; var gb = /opacity=([^)]*)/; var hb = /-([a-z])/ig; var ib = /([A-Z])/g; var Fa = /^-?\d+(?:px)?$/i
  ...
  }, swap: function(a, b, d) { var e = {}; var f; for (f in b) { e[f] = a.style[f]; a.style[f] = b[f] }d.call(a); for (f in b)a.style[f] = e[f] }, camelCase: function(a) { return a.replace(hb, lb) } }); c.curCSS = c.css; c.each(['height', 'width'], function(a, b) {
...
d.filter || ''; d.filter = Ea.test(f) ? f.replace(Ea, e) : d.filter + ' ' + e
  ...
  var ob = /^(?:select|textarea)/i; var pb = /^(?:color|date|datetime|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i; var qb = /^(?:GET|HEAD)$/; var Ra = /\[\]$/; var T = /\=\?(&|$)/; var ja = /\?/; var rb = /([?&])_=[^&]*/; var sb = /^(\w+:)?\/\/([^\/?#]+)/; var tb = /%20/g; var ub = /#.*$/; var Ha = c.fn.load; c.fn.extend({ load: function(a, b, d) {
...
encodeURIComponent(h) + '=' + encodeURIComponent(l)
  ...
  if (E.ActiveXObject)c.ajaxSettings.xhr = function() { if (E.location.protocol !== 'file:') try { return new E.XMLHttpRequest() } catch (a) {} try { return new E.ActiveXObject('Microsoft.XMLHTTP') } catch (b) {} }; c.support.ajax = !!c.ajaxSettings.xhr(); var ea = {}; var vb = /^(?:toggle|show|hide)$/; var wb = /^([+\-]=)?([\d+.\-]+)(.*)$/; var ba; var pa = [['height', 'marginTop', 'marginBottom', 'paddingTop', 'paddingBottom'], ['width', 'marginLeft', 'marginRight', 'paddingLeft', 'paddingRight'], ['opacity']]; c.fn.extend({ show: function(a, b, d) {
    if (a || a === 0) {
...
parseFloat(d.borderTopWidth) || 0; o += parseFloat(d.borderLeftWidth) || 0
    ...
    var a = t.body; var b = t.createElement('div'); var d; var e; var f; var h = parseFloat(c.css(a, 'marginTop')) || 0; c.extend(b.style, { position: 'absolute', top: 0, left: 0, margin: 0, border: 0, width: '1px',
