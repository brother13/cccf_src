            ...
            if (checktype === "other") {
              ...
              for (let p = 0; p < pages.length; p++) {
                ...
                if (pageheight < pageheight_A4 * 0.6) {
                  ...
                  // page.moveUp(pageheight_A4 - pageheight); // 上移
                  // const pagenew = pdfNewDoc.addPage();
                  // const pagenew = pdfNewDoc.embedPage(page, {
                  //   left: 55,
                  //   bottom: 485,
                  //   right: 300,
                  //   top: 575,
                  // });
                  // const page_add = pdfNewDoc.addPage();
                  // console.log("page_add size", page_add.getSize());

                  // const page_cut = await pdfNewDoc.embedPage(page, {
                  //   left: 0,
                  //   right: page.getWidth(),
                  ...
                  // page_add.drawPage(page_cut, {
                  //   ...page_cut,
                  //   x: 0,
                  //   y: page_add.getHeight(),
                  // });
                  // pdfNewDoc.addPage(page_add);
                  // page.translateContent(0, pageheight_A4 - pageheight);
                  // page.moveUp(pageheight_A4 - pageheight);
                  // page.scaleAnnotations(1, 1);

                  // const artbox = page.getArtBox();
                  // console.log("page.getArtBox()", artbox);
                  // page.setArtBox(0, page.getHeight() / 2, artbox.width, artbox.height);

                  // const extraHeight = pageheight_A4 - pageheight;
                  ...
                  //   width: page.getWidth(),
                  //   height: extraHeight,
                  //   color: rgb(0.5, 0.5, 0.5), // 这里填充白色背景，可以根据需要设置其他颜色
                  // });

                  // await this.convertPdfPageToPng(pdffileObj, p);
