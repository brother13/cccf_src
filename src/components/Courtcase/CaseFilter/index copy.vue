      ...
      >
        <el-form-item label="模糊搜索">
          <el-input
            ...
            class="form-item"
            placeholder="请输入关键字：单据号、通知书号、案号、单位名称、操作员、承办人等信息"
          />
        </el-form-item>
        <!-- 收退款才有通知书号 -->
        ...
        <el-form-item
          :label="
            temp.typeid > 200 && temp.typeid < 300 ? '原单据号' : '单据编号'
          "
        >
        ...
        <template v-if="temp.typeid < 300 && temp.typeid > 100">
          <el-form-item label="完整案号">
            <el-input
              v-model="temp.caseinfo"
              class="form-item"
              placeholder="支持模糊搜索案号"
            />
          </el-form-item>
          <el-form-item label="案件年号">
            <el-input
              v-model="temp.caseyear"
              class="form-item"
              style="width: 200px"
            />
            <span class="form-label">案件序号</span>
            <el-input
              v-model="temp.casenum"
              class="form-item"
              style="width: 200px"
            />
          </el-form-item>
        ...
        <el-form-item label="承办部门">
          <el-select v-model="temp.deptcode" multiple class="form-item">
            <el-option
        ...
        <el-form-item label="状　　态">
          <el-select v-model="temp.isvoid" class="form-item">
            <el-option
              v-for="item in basedata.voidStatusList"
              :key="item.id"
              :label="item.label"
              :value="item.value"
            />
        ...
        <el-form-item
          v-if="temp.typeid == 104 || temp.typeid == 110"
          label="入库状态"
        >
