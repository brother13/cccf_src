      ...
      <el-col :span="8">
        <div>
          ...
          >
            ...
            <el-form-item label="备注信息" prop="note" v-show="batchinfo.notetype == 1">
              <el-input
            ...
            <el-form-item label="执行进度" v-show="batchinfo.isdoing">
              正在生成第 {{ batchinfo.done + 1 }} / {{ batchinfo.total }} 笔
            </el-form-item>
          </el-form>
          <div slot="footer" class="dialog-footer" style="text-align: center">
            <el-button @click="showWindow = false" :disabled="batchinfo.isdoing"
              >取消</el-button
            >
            <el-button
              type="primary"
  ...
  methods: {
    ...
    async saveData() {
      ...
      for (let i = 0; i < this.batchinfo.items.length; i++) {
        ...
        let info = Object.assign({}, this.detail_temp);
