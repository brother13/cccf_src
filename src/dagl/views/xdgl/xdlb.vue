<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.keyword" clearable placeholder="被控制对象、案号" style="width: 230px" class="filter-item"
        @keyup.enter.native="handleFilter">
        <i slot="prefix" class="el-input__icon el-icon-search" />
      </el-input>
      <span class="filter-item" style="color: #606266">上次控制时间：</span>
      <el-date-picker label="上次控制时间" v-model="listQuery.startdate" type="date" placeholder="起始时间" class="filter-item"
        style="width: 150px" value-format="yyyy-MM-dd" @change="handleFilter" />
      <el-date-picker label="上次控制时间" v-model="listQuery.enddate" type="date" placeholder="结束时间" class="filter-item"
        style="width: 150px" value-format="yyyy-MM-dd" @change="handleFilter" />
      <el-option v-for="item in DeptList" :key="item.deptid" :label="item.fullname"
        :value="item.deptid">{{ item.deptname }}</el-option>
      </el-select>
      <el-select v-model="listQuery.zt" placeholder="冻结状态" clearable style="width: 140px" class="filter-item"
        @change="handleFilter">
      ...
      <span class="filter-item" style="color: #606266;margin-left: 10px"><el-switch v-model="listQuery.xkzjeflag"
          active-text="新控制金额" inactive-text="" @change="handleFilter">
        </el-switch></span>
    </div>
    ...
    <el-dialog custom-class="saveAsDialog" :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible"
      ...
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="130px"
        ...
        <el-form-item label="新控制金额">
          <el-input disabled v-model="temp.newje" />
        </el-form-item>
        ...
        <el-form-item label="提起控制时间">
          <el-date-picker label="提起控制时间" v-model="temp.querytime" type="datetime" placeholder="提起控制时间"
            value-format="yyyy-MM-dd HH:mm:ss" />
        </el-form-item>
        <el-form-item label="控制到期时间">
          <el-date-picker label="控制到期时间" v-model="temp.enddate" type="datetime" placeholder="控制到期时间"
            value-format="yyyy-MM-dd HH:mm:ss" />
        </el-form-item>
        <el-form-item label="上次控制时间">
          <el-date-picker label="上次控制时间" v-model="temp.lastdate" type="datetime" placeholder="上次控制时间"
            value-format="yyyy-MM-dd HH:mm:ss" />
        </el-form-item>
        <el-form-item label="本次控制时间">
          <el-date-picker label="本次控制时间" v-model="temp.thisdate" type="datetime" placeholder="本次控制时间"
            value-format="yyyy-MM-dd HH:mm:ss" />
        </el-form-item>
