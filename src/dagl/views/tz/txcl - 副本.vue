<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.keyword" clearable placeholder="请输入关键字，姓名,案号" style="width: 220px"
    ...
    <el-dialog custom-class="saveAsDialog" :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible"
      ...
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="80px"
        ...
        <el-form-item label="办案人" prop="cbr">
          <el-input disabled v-model="temp.cbr" />
        </el-form-item>
        ...
        <el-form-item label="财产情况" prop="status">
          <el-input v-model="temp.ccqk" :autosize="{ minRows: 4, maxRows: 6 }" type="textarea"
        ...
        <el-form-item label="自动续封">
          <el-switch v-model="temp.aotocf" active-color="#13ce66" inactive-color="#ff4949" :inactive-value="1"
            :active-value="1" />
