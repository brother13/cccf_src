...
const fieldList = [
  ...
  { field: 'djcode', label: '来源票据号码', export: true, show: true, order: true, width: 130 },
  { field: 'ah', label: '案号', export: true, show: true, width: 220, order: true },
  {
    field: 'czdate',
    label: '出账日期',
    export: true,
  ...
  { field: 'skr', label: '实际收款人', export: true, show: true, width: 200 },
  { field: 'skr_accountname', label: '领款人账号全称', export: true, show: true, width: 200 },
  { field: 'skr_account', label: '领款人账号', export: true, show: true, width: 200 },
  { field: 'skr_bank', label: '领款人开户行', export: true, show: true, width: 200 },
  { field: 'skr_gx', label: '收款人关系', export: true, show: true },
  // {
  //   field: 'cbbm',
  //   label: '承办部门',
  //   export: true,
  ...
  { field: 'note', label: '承办人情况说明', export: true, show: true, width: 200 },
