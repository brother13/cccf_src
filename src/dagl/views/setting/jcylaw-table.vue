<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="项目名称" prop="itemname" align="center" width="120" />
      <el-table-column label="检查内容" prop="checktype" align="center" width="120" />
      <el-table-column label="具体要求" prop="requiretext" align="center" width="300" :show-overflow-tooltip="true" />
      <el-table-column label="法律依据" prop="lawname" align="center" width="160" />
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        <el-form-item label="检察内容" prop="checktype">
          <el-input v-model="temp.checktype" />
        </el-form-item>
        <el-form-item label="具体要求">
          <el-input
            v-model="temp.requiretext"
