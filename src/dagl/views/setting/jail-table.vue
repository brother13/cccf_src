<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="监狱类型" prop="jailtype" align="center" width="120" />
      <el-table-column label="监狱名称" prop="jailname" align="center" width="120" />
      <el-table-column label="省份" prop="provice" align="center" width="120" />
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        <el-form-item label="监狱名称" prop="jailname">
          <el-input v-model="temp.jailname" />
        </el-form-item>
        <el-form-item label="监狱类型" prop="jailtype">

          <el-select
            v-model="temp.jailtype"
            placeholder="请选择监狱类型"
            clearable
            style="width: 100%"
            class="filter-item"
    ...
    <el-dialog :visible.sync="dialogPvVisible" title="Reading statistics">
      ...
      <span slot="footer" class="dialog-footer">
        <el-button type="primary" icon="el-icon-check" @click="dialogPvVisible = false">确认</el-button>
      </span>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  methods: {
    init() {
      postdata('/data/list', { type: 'typeinfo' }).then((response) => {
        console.log(response)
        const resdata = response.data
        this.jailtypeList = resdata.items
      })
    },
