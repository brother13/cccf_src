        ...
        <el-form-item label="上级部门">
          ...
          >
            ...
            <el-option
              ...
              :key="item.deptid"
              :disabled="item.deptid == temp.deptid || item.parentid==temp.deptid"
              :label="item.fullname"
              :value="item.deptid"
...
<script>
import { DeptSave, DeptAdd, DeptDel, DeptNewCode } from '@/web/api/dept'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      postdata('/dept/tree').then((response) => {
