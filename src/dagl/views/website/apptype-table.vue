<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="应用分类" prop="apptype" align="center" width="120" />
      <!-- <el-table-column label="应用类型" prop="apptype" align="center" width="120" /> -->
      <el-table-column label="应用图标" prop="icon" align="center" width="120">
        <template slot-scope="{row}">
          <template v-if="row.icon">
            <LinkIcon :src="row.icon" />
            <!-- <el-image :src="row.icon" class="icon-image"></el-image> -->
          </template>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" :close-on-click-modal="false">
      ...
      >
        ...
        <el-form-item label="分类名称" prop="apptype">
          <el-input v-model="temp.apptype" />
        </el-form-item>
        ...
        <el-form-item label="是否有分类">
          <el-switch
            ...
            :inactive-value="0"
          />
          <el-tag>{{ temp.hassub==1 ? "拥有子分类" : "无" }}</el-tag>
        </el-form-item>
