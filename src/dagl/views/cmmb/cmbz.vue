<template>
  <div class="app-container">
    <div class="filter-container">
      <el-select v-model="listQuery.parentid" placeholder="请选择尺码模板" clearable style="width: 250px" class="filter-item"
        @change="handleFilter">
        <el-option v-for="item in cmmbupList" :key="item.cmmbid" :label="item.fullname"
          :value="item.cmmbid">{{ item.cmmbname }}</el-option>
      </el-select>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" :close-on-click-modal="false">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="80px"
        ...
        <el-form-item label="尺码" prop="cmmbname" >
          <el-input :disabled="true" v-model="temp.cmmbname" />
        </el-form-item>

        <el-form-item label="性别" prop="sex">
          <el-select v-model="temp.sex" style="width: 100%" class="filter-item" placeholder="请选择" clearable>
            <el-option v-for="item in Sextype" :key="item.id" :label="item.typename"
