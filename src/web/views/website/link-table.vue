<template>
  <div class="app-container">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" :close-on-click-modal="false">
      ...
      >
        <el-form-item label="链接名称" prop="linktext">
          <el-input v-model="temp.linktext" />
        </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      export: {
        title: '友情链接',
        header: ['ID', '链接名称', '链接地址', '链接说明', '更新时间'],
        field: ['id', 'linktext', 'linkurl', 'linkcomment', 'updatetime']
      },
