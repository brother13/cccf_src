<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="当事人" prop="bzxr" align="center" width="200" sortable="khh">
        <template slot-scope="{row}">
          <span>{{ row.bzxr }}</span>
          <br>
          <span>{{ row.zjhm }}</span>
      ...
      <el-table-column label="银行账号" prop="khh" align="center" width="220" sortable="khh">
        <template slot-scope="{row}">
          <span>{{ row.khh }}</span>
          <br>
          <span>{{ row.khxx }}</span>
      ...
      <el-table-column label="余额" prop="kyye" align="center" width="180" sortable="kyye">
        <template slot-scope="{row}">
          <span>余额：{{ row.ye }}</span>
          <br>可用：
          <span class="money">{{ row.kyye }}</span>
        </template>
      </el-table-column>
